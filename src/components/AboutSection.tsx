    ...
    <section className="bg-black text-white px-6 py-20 md:py-28">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl leading-relaxed">
          Welcome to <span className="text-[#FF0000] font-semibold">FitZone Gym</span> — Bhopal’s destination for fitness, strength, and transformation.
        </p>

        <div className="mt-10 space-y-6  text-base md:text-lg leading-loose">
          <p>
          ...
          <p>
            Join the <span className="text-[#AF0404] font-semibold">FitZone family</span> and take your first step toward a stronger, healthier you — right here in

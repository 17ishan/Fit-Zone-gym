...
const services = [
  ...
  {
    icon: <StretchHorizontal size={40} className="text-blue-500" />,
    ...
    <section className="relative w-full min-h-screen bg-black text-white px-6 py-24 flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl w-full px-4">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-white/10 hover:border-blue-500 transition duration-300 shadow-md hover:shadow-blue-700/30"
          >
